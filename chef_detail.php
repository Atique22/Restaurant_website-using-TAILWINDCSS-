...
<section class="text-gray-600 body-font"  style="background-color: black; border-radius: 10px; margin: 80px">
    <div class="container px-5 py-24 mx-auto" >
        <div class="flex flex-col text-center w-full mb-20">
            <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-white">Chef Detail</h1>
        </div>
        <div class="lg:w-3/3 w-full mx-auto overflow-auto" style="background-color: white">
            <table class="table-auto w-full text-left whitespace-no-wrap" >
                <thead>
                <tr>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">CHEF id.</th>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Name</th>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">CNIC</th>
        ...
        <?php
                ...
                $result = mysqli_query($con,"SELECT * FROM `chef`");
                while($row = mysqli_fetch_assoc($result)){
                ?>
        		        <tr>
                                <td><?php echo $row['CHEF ID']?>  </td>
