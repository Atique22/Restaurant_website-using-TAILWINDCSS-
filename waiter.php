...
<header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <div class="lg:w-4/5 inline-flex lg:justify-end ml-5 lg:ml-0">
            <a href="logout.php">  <button class="inline-flex items-center bg-green-100 border-0 py-1 px-3 focus:outline-none hover:bg-blue-200 rounded text-base mt-4 md:mt-0">Logout
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div class="p-4 lg:w-1/2">
            <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                <img alt="team" class="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="./ajk_img/mirza.jpg">
                <div class="flex-grow sm:pl-8">
                    <h2 class="title-font font-medium text-lg text-gray-900">Mirza Mukarram Baig  </h2>
                    <h3 class="text-gray-500 mb-3">WAITER</h3>
                    <p class="mb-4">It is a good thing that life is not as serious as it seems to a waiter.</p>
                    <span class="inline-flex">
              <a class="text-gray-500" href="https://www.facebook.com/mukkaram.mirza">
